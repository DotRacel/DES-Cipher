--[[
    Implemented for gamesense lua environment.

    from https://github.com/somesocks/lua-lockbox
]]
...
-- region start: PKCS7Padding
local PKCS7Padding

do
    PKCS7Padding = function(blockSize, byteCount)
...
-- region end: PKCS7Padding

-- region start: ZeroPadding
local ZeroPadding

do
    ZeroPadding = function(blockSize, byteCount)
